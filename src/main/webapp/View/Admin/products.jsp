...
<%--                    <th scope="col">&nbsp;</th>--%>
                ...
                <c:forEach var="product" items="${products}" varStatus="loop">
                  <tr data-href = "front?controller=adminEditProduct&id=${product.id}">
<%--                    <th scope="row"><input type="checkbox" data-product-id="${product.id}" /></th>--%>
            ...
            <!-- table container -->
            <a
              href="front?controller=adminAddProduct"
