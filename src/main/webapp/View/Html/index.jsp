    ...
    <section class="section-slide">
      <div class="wrap-slick1">
        <div class="slick1">
          <div
            class="item-slick1"
            style="background-image: url(assets/Images/slide-01.jpg)"
          >
          ...
          <div
            class="item-slick1"
            style="background-image: url(assets/Images/slide-02.jpg)"
          >
            <div class="container h-full">
              <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                <div
          ...
          <div
            class="item-slick1"
            style="background-image: url(assets/Images/slide-03.jpg)"
          >
            <div class="container h-full">
              <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                <div
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
            <!-- Block1 -->
            <div class="block1 wrap-pic-w">
              <img src="assets/Images/banner-10.jpeg" alt="IMG-BANNER" />

              <a
                href="front?controller=products&category=shoes"
                class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3"
              >
                <div class="block1-txt-child1 flex-col-l">
                  <span class="block1-name ltext-102 trans-04 p-b-8">
          ...
          <div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
            ...
            <div class="block1 wrap-pic-w">
              ...
              <a
                href="front?controller=products&category=watches"
                class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3"
              >
                <div class="block1-txt-child1 flex-col-l">
                  <span class="block1-name ltext-102 trans-04 p-b-8">
...
<%--                    <div--%>
<%--                      class="item-slick3"--%>
<%--                      data-thumb="../assets/Images/product-detail-02.jpg"--%>
<%--                    >--%>
<%--                      <div class="wrap-pic-w pos-relative">--%>
<%--                        <img--%>
...
<%--                    <div--%>
<%--                      class="item-slick3"--%>
<%--                      data-thumb="../assets/Images/product-detail-03.jpg"--%>
<%--                    >--%>
<%--                      <div class="wrap-pic-w pos-relative">--%>
<%--                        <img--%>
